...
const ensureTeacherAssignmentModel = () => {
    if (!TeacherAssignment) {
        const error = new Error('Teacher assignments model has been removed. This operation is unavailable.');
        error.status = 410;
        throw error;
    }
};
